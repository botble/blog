...
tags:
  ...
  - botble
  - codecanyon
image: https://landing.botble.com/travlla/screenshots/home-1.png
status: published
is_featured: true
---
...
This is what sets Travlla apart from a simple booking theme. Travlla includes a **complete multi-vendor system** so you can run a travel marketplace, not just a single agency:

- Tour operators and guides register as **vendors** and get their own dashboard
- Vendors create and manage their own tours, with admin **moderation** before tours go live
- Each vendor sees their own bookings, revenue, and balance
- **Category commissions** let you set how much you earn per sale, per category
- Vendors request **withdrawals**, and you approve payouts from the admin panel

Whether you run a single travel agency or a marketplace of independent operators, Travlla scales to fit.

![Travlla admin bookings management dashboard](https://landing.botble.com/travlla/screenshots/admin-bookings.png)

### Destinations & Discovery

Showcase the places you sell. Dedicated destination pages let travelers explore by location, with multiple grid and sidebar layouts to match your design. Combine destinations, categories, and the built-in compare and FAQ pages to help travelers make decisions faster.

![Travlla destinations listing page](https://landing.botble.com/travlla/screenshots/destinations.png)

### Multi-Currency & Multi-Language

Sell to a global audience. Travlla supports multiple currencies so travelers see prices in their own money, and unlimited languages with full RTL support for Arabic, Persian, and Hebrew. A built-in translation tool makes localizing both the front theme and admin panel straightforward.
...
Travlla comes with popular payment gateways ready to enable:
...
Plus Cash on Delivery and Bank Transfer through the underlying Botble CMS payment system.

## Built on Botble CMS

Travlla is built on top of **Botble CMS**, a mature Laravel platform used by thousands of customers. That means you inherit a battle-tested foundation:

- Pages, blog, menus, contact forms, and newsletter modules
...
| Homepages | 5 ready-made layouts |
| Pages | 40+ inner pages |
| Languages | Unlimited, with full RTL support |
| Currencies | Multi-currency support |
| Coding Standard | PSR-12 |
| Installation | Web installer (no CLI needed) |

## Demo & Support

- **Live Demo**: [https://travlla.botble.com](https://travlla.botble.com)
- **Admin Demo**: [https://travlla.botble.com/admin](https://travlla.botble.com/admin) (admin / 12345678)
- **Documentation**: [https://docs.botble.com/travlla](https://docs.botble.com/travlla)
...
- 5 homepages and 40+ pages
- Built-in vendor marketplace
- Multi-currency and unlimited languages
- Powerful admin panel and REST API
...
**[Browse on CodeCanyon](https://codecanyon.net/user/botble/portfolio)**

**[Read Documentation](https://docs.botble.com/travlla)**

---

*Travlla is built on [Botble CMS](https://botble.com), a modern Laravel-based platform. Visit [botble.com](https://botble.com) for more products and information.*
